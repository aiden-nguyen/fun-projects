...
public class CuteUgly extends ScheduleActions_Moving {

    private static final String QUAKE_KEY = "quake";
    public CuteUgly(String id, Point position, List<PImage> images, int actionPeriod, int animationPeriod){
    ...
    public static CuteUgly createCuteUgly(String id, Point position,
                                            int actionPeriod, int animationPeriod,
                                            List<PImage> images)
    {
        return new CuteUgly(id, position, images,
                actionPeriod, animationPeriod);
    }

    private boolean moveToCuteUgly(WorldModel world, Entity target, EventScheduler scheduler)
    {
    ...
    public void execute(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        ...
        for (Entity entity : world.getEntities()) {
            if ((entity.getClass() == JellyFish_Full.class)|| (entity.getClass() == JellyFish_Not_Full.class)
                    || (entity.getClass() == Penguin.class) || (entity.getClass() ==Flower.class) ||
                    (entity.getClass() == BigBertha.class) || (entity.getClass() == Obstacle.class))
            {
                ofType.add(entity);
            }
        }
        ...
        if (BigBerthaTarget.isPresent())
        {
            ...
            if (this.moveToCuteUgly(world, BigBerthaTarget.get(), scheduler))
            {
