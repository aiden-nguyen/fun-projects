...
//controls drawing what part of the world we can see
...
final class WorldView
{
   ...
   public void drawBoat(int x, int y, ImageStore imageStore) throws InterruptedException {
      List<PImage> boattings = imageStore.getImageList(BOAT_ID);
      world.drawBoatWorld(x,y,viewport,boattings);
      world.drawBoatWorld(x+1,y+1,viewport,boattings);
      world.drawBoatWorld(x+1,y-1,viewport,boattings);
      world.drawBoatWorld(x+2,y+2,viewport,boattings);
      world.drawBoatWorld(x+2,y-2,viewport,boattings);
      world.drawBoatWorld(x+3,y+3,viewport,boattings);
      world.drawBoatWorld(x+3,y-3,viewport,boattings);
   }
